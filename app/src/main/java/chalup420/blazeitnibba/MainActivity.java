package chalup420.blazeitnibba;
...
public class MainActivity extends Activity {
    ...
    Button Adelante, Reversa, Izquierda, Derecha;
    Switch Velocidad, Fokitoz;
    Handler bluetoothIn;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Reversa = (Button) findViewById(R.id.Reversa);
        Izquierda = (Button) findViewById(R.id.Izquierda);
        Derecha = (Button) findViewById(R.id.Derecha);
        Velocidad = (Switch) findViewById(R.id.VELOCIDAD);
        Fokitoz = (Switch) findViewById(R.id.Fokitoz);
        ...
        Adelante.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                Toast.makeText(getBaseContext(), "Puto el que lo lea, menos Trejo", Toast.LENGTH_SHORT).show();
            }
        });

        Reversa.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
        ...
        Fokitoz.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (Fokitoz.isChecked()){
